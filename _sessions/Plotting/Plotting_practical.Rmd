...
7. You'll notice that the `mcdonalds` data frame has many column names with spaces and 'bad' characters like parentheses. Run the following dplyr code to fix that!
...
8. Now print the dataset again, do the names look better?
