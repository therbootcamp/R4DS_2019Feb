...
The first few rows and columns of the dataset(s) should look as follows:

*First 5 rows and 5 columns of trial_act*

```{r, eval = TRUE, echo = FALSE}
knitr::kable(trial_act[1:5, 1:5])
```

*First 5 rows of trial_act_demo*
