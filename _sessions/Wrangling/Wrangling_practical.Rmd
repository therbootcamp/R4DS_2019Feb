...
2. Your goal is to combine the data two datasets and then explore using a combination of `filter` and then `mean` (see code below), whether the patients are more likely to not show up for their appointment during bad versus good weather conditions.
