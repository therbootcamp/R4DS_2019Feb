...
5. [**Tidyverse**](https://www.tidyverse.org/) (`dplyr`, `ggplot2`, etc.)
...
```{r, eval=F}
# message - attend
basel <- type_convert(df = baselers)
```

```{r, echo=F, error=T}
# message - attend
basel <- type_convert(df = baselers[1:6])
```
...
<h1><a href="https://therbootcamp.github.io/R4DS_2019Feb/1_Data/BaselRBootcamp.zip">Downloads</a></h1>
